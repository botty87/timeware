...
import '../../features/species/data/datasources/species_data_source.dart' as _i15;
import '../../features/species/data/repositories/species_repository_impl.dart' as _i17;
import '../../features/species/domain/repositories/species_repository.dart' as _i16;
import '../../features/species/domain/usecases/get_species.dart' as _i18;
import '../../features/species/domain/usecases/get_species_details.dart' as _i19;
import '../../features/species/presentation/cubit/species/species_cubit.dart' as _i21;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i8.UserRepository>(() => _i9.UserRepositoryImpl(gh<_i7.UserDataSource>()));
    gh.lazySingleton<_i10.LoginUser>(() => _i10.LoginUser(gh<_i8.UserRepository>()));
    gh.lazySingleton<_i11.BlocObserver>(() => _i12.SimpleBlocObserver(logger: gh<_i5.Logger>()));
    gh.singleton<_i13.UserCubit>(() => _i13.UserCubit(gh<_i3.SharedPreferences>()));
    ...
    gh.lazySingleton<_i18.GetSpecies>(() => _i18.GetSpecies(gh<_i16.SpeciesRepository>()));
    ...
    gh.factory<_i21.SpeciesCubit>(() => _i21.SpeciesCubit(gh<_i18.GetSpecies>()));
    return this;
  }
}
