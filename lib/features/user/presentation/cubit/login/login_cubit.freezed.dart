...
class __$$LoginStateImplCopyWithImpl<$Res> extends _$LoginStateCopyWithImpl<$Res, _$LoginStateImpl>
  ...
  __$$LoginStateImplCopyWithImpl(_$LoginStateImpl _value, $Res Function(_$LoginStateImpl) _then)
      : super(_value, _then);
...
class _$LoginStateImpl implements _LoginState {
  const _$LoginStateImpl({this.email = '', this.password = '', this.error, this.loggedInUser});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.loggedInUser, loggedInUser) || other.loggedInUser == loggedInUser));
  }

  @override
  int get hashCode => Object.hash(runtimeType, email, password, error, loggedInUser);
